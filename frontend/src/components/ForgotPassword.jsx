...
export default function ForgotPassword() {
  return (
    <section className="bg-[url('assets/realflowimage.jpg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply bg-opacity-80">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen pt:mt-0">
        ...
        <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
          ...
          <h2 className="mb-1 text-xl font-regular leading-tight tracking-tight text-gray-400 md:text-sm dark:text-white">
