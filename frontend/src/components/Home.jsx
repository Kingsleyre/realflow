  ...
  return (
            ...
            <div className="flex items-center justify-start">
               ...
               <form action="#" method="GET" className="hidden lg:block lg:pl-32">
                  ...
                  <div className="mt-1 relative lg:w-64">
                     ...
                     <input type="text" name="email" id="topbar-search" className="bg-gray-100 border border-gray-200 text-gray-900 sm:text-sm rounded-lg focus:ring-gray-300 focus:border-gray-300 block w-full pl-10 p-2.5" placeholder="Search"/>
                  </div>
               </form>
            </div>
   ...
   <div className="flex overflow-hidden bg-white pt-16">
      <aside id="sidebar" className="fixed hidden z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
         <div className="relative flex-1 flex flex-col min-h-0 border-r border-gray-100 bg-gray-100 pt-0">
               ...
               <div className="flex-1 px-3 bg-gray-100 divide-y space-y-1">
                  <ul className="space-y-2 pb-2">
                     ...
                     <a href="#" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <span className="ml-3 flex-1 whitespace-nowrap"> Users Activity </span>
                        </a>
      ...
      <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
         ...
         <p className="text-center text-sm text-gray-500 my-10">
            &copy; 2023 <a href="/" className="hover:underline" target="_blank">RealFlow</a>. All rights reserved.
         </p>
      </div>
   </div>
