                  ...
                  <div className="flex-grow flex items-center border-b border-gray-100 dark:border-gray-400 text-sm text-gray-600 dark:text-gray-100 py-2">
                    <div className="flex-grow flex justify-between items-center">
                      <div className="self-center">
                        ...
                        mentioned{' '}
                        <a
                          className="font-medium text-gray-800 dark:text-gray-50 dark:hover:text-gray-100 no-outline"
                          href="#0">
                          Sara Smith
                        </a>{' '}
                        in a new post
                      ...
                      <div className="flex-shrink-0 ml-2">
                        <a
                          href="#0"
                          className="flex items-center font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-500 outline-none">
                          View
