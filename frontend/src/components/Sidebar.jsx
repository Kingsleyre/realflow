...
export default function Sidebar() {
  return (
    <>
      <div className="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-gray-300  h-full text-white transition-all duration-300 border-none z-10 sidebar">
        <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul className="flex flex-col py-4 space-y-1">
            <li className="px-5 hidden md:block">
              <div className="flex flex-row items-center h-8">
                <div className="text-sm font-light tracking-wide text-gray-900 uppercase">
                  Main
                </div>
              </div>
            </li>
            <li>
              <a
                ...
                <span className="ml-2 text-sm tracking-wide truncate text-gray-900">
                  Dashboard
                </span>
              </a>
          ...
          {/* <p className="mb-14 px-5 py-3 hidden md:block text-center text-xs text-gray-900">
            Copyright 2023 RealFlow, Inc. All rights reserved.
          </p> */}
        </div>
      </div>
    </>
