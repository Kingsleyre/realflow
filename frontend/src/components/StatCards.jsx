...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
  <div className="bg-blue-500 dark:bg-gray-300 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-black text-gray-900 font-medium group">
    <div className="flex justify-center items-center w-14 h-14 bg-gray-200 rounded-full transition-all duration-300 transform group-hover:rotate-12">
